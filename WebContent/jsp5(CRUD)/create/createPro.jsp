...
<body>
	...
	<%
		...
		// 3 sql 쿼리생성 & stmt(statement) 객체 생성
		// String sql = "insert into itwill_member	values('"+id+"', '"+pw+"', '"+name+"', '"+gender+"', '"+age+"','"+email+"', '"+reg_date+"')";
