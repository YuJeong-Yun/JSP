...
<body>
	...
	2) 페이지 정보(응답 정보) + 쿠키 정보(이름, 값 쌍으로 만들어진 배열 형태) 받아옴
	3) 쿠키 배열을 통해서 이름 정보를 사용해서 값을 활용
	 
	 크롬 쿠키가 저장되는 주소
	 C:\\Users\\ITWIL\\AppData\\Local\\Google\\Chrome\\User Data\\Default\\Cache\\Cache_Data
	 -->
		...
		if (cookies != null) {
			for (Cookie i : cookies) {
				...
				if (i.getName().equals("name")) {
					System.out.println("쿠키값 : " + i.getValue());
					cName = i.getName();
					cValue = i.getValue();
				}
			}
